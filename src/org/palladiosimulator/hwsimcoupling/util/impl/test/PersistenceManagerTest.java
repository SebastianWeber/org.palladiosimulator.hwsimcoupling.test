...
public class PersistenceManagerTest {
    ...
    void testSaveAndLoadProfiles() {
        ...
        assertEquals(1, PersistenceManager.loadProfiles()
            .size());
    ...
    void testSaveAndLoadDemands() {
        // If there is no profile a default profile will be returned
        assertEquals(0, PersistenceManager.loadDemands()
            .size());
        Map<String, Map<String, String>> demands = TestHelper.generateRandomMapOfMaps();
        PersistenceManager.saveDemands(demands);
        Map<String, Map<String, String>> demandsLoaded = PersistenceManager.loadDemands();
